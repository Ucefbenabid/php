      ...
      <div class="swiper-wrapper">
          ...
          <div class="swiper-slide slide">
            <div class="content">
               ...
               <h3>Couscous Diari</h3>
               <a href="menu.php" class="btn">Voir le menu</a>
            </div>
            <div class="image">
               <img src="images/KOUSKOUS.png" alt="">
            </div>
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <div class="image">
               <img src="images/rouz-jerbi.png" alt="">
            </div>
         </div>
...
<section class="category">
   ...
   <div class="box-container">
      ...
      <a href="category.php?category=fast food" class="box">
         <img src="images/fast-food_737967.png" alt="">
         <h3>fast food</h3>
      </a>

      <a href="category.php?category=main dish" class="box">
         <img src="images/food-tray_7951523.png" alt="">
         <h3>Plats</h3>
      </a>
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <div class="flex">
            <div class="price"><span></span><?= $fetch_products['price']; ?>  TND</div>
