...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      $message[] = 'email ou numreo de telephone existe deja!!';
   }else{
      if($pass != $cpass){
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" required placeholder="entrez votre email" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="number" name="number" required placeholder="entrez votre numero de telephone" class="box" min="0" max="9999999999" maxlength="10">
